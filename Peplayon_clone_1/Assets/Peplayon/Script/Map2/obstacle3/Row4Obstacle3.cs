...
public class Row4Obstacle3 : NetworkBehaviour
{
    public static Row4Obstacle3 instance;
    ...
    {
        listOsbtacle.Clear();
        Row5Obstacle3.instance.listOsbtacleSelected.Clear();
    ...
    private void Update()
    {
        ...
        {
            Row5Obstacle3.instance.listOsbtacleSelected.Clear();
            Row5Obstacle3.instance.trapAdded = true;
            Row5Obstacle3.instance.listOsbtacleSelected.Clear();
            trapAdded = false;
            for (int i = 0; i <= 3; i++)
            {
            ...
            for (int i = 0; i <= listOsbtacleSelected.Count - 1; i++)
            {
                ...
                {
                    Row5Obstacle3.instance.listOsbtacleSelected.Add(listOsbtacle[0]);
                    SetTrapClient(0);
                ...
                {
                    Row5Obstacle3.instance.listOsbtacleSelected.Add(listOsbtacle[1]);
                    SetTrapClient(1);
                ...
                {
                    Row5Obstacle3.instance.listOsbtacleSelected.Add(listOsbtacle[2]);
                    SetTrapClient(2);
                ...
                {
                    Row5Obstacle3.instance.listOsbtacleSelected.Add(listOsbtacle[3]);
                    SetTrapClient(3);
