...
public class CutScene : MonoBehaviour
{
    ...
    private IEnumerator startCutscene3()
    {
        ...
        LeanTween.move(Camera1.gameObject, new Vector3(17.7510529f, 77.18f, 50.2196274f), 1f);
        LeanTween.rotate(Camera1.gameObject, new Vector3(18.8000011f, 185.800018f, 0), 1f);
