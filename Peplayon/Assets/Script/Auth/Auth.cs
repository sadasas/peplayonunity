...
namespace PeplayonAuth
{
    public class Auth : MonoBehaviour
    {
        ...
        [SerializeField] public TMP_InputField PassLogin;
        [SerializeField] public Button LoginBtn;


        [Header("Sign Up")]
        [SerializeField] public Canvas CanvasSignup;
        [SerializeField] public TMP_InputField NameSignup;
        [SerializeField] public TMP_InputField UsernameSignup;
        [SerializeField] public TMP_InputField PassSignup;
